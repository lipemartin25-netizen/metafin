...
export default function CreditCard() {
 ...
 <p className="text-[var(--text-primary)]/40 text-[10px] font-bold tracking-widest uppercase">Meu Cartão Virtual</p>
 ...
 <div className="w-8 h-6 rounded-sm bg-[var(--bg-base)] from-yellow-400 to-yellow-600 opacity-90 shadow-lg shadow-black/10" />
 <Wifi size={18} className="text-[var(--text-primary)]/30 rotate-90" />
 </div>

 <div>
 <p className="text-[var(--text-primary)] font-mono text-sm tracking-[0.2em] mb-1">
 {isVisible ? "•••• •••• •••• 4892" : "•••• •••• •••• ••••"}
 </p>
 <div className="flex items-center justify-between">
 <div>
 <p className="text-[var(--text-primary)]/30 text-[8px] uppercase font-bold tracking-tighter">Titular</p>
 <p className="text-[var(--text-primary)]/80 text-[10px] font-bold uppercase truncate max-w-[100px]">Felipe Martin</p>
 </div>
 <div>
 <p className="text-[var(--text-primary)]/30 text-[8px] uppercase font-bold tracking-tighter">Validade</p>
 <p className="text-[var(--text-primary)]/80 text-[10px] font-bold">12/28</p>
 </div>
 </div>
 </div>
 </div>
 ...
 <span className="text-[var(--text-primary)]/40">Limite utilizado</span>
 ...
 <p className="text-[9px] text-[var(--text-primary)]/20 font-medium italic">Vence em 12 dias</p>
 </div>
 </div>
 </div>
 );
