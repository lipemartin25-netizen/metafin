...
export default function FinancialEducation() {
 ...
 {tracks.map(track => (
 <div key={track.id} className={`\${tw.glass-card} p-6 flex flex-col group hover:-translate-y-px transition-all duration-300`}>
 ...
 <h3 className="text-xl font-bold text-[var(--text-primary)] dark:text-[var(--text-primary)] mb-2 group-hover:text-brand-500 transition-colors">
 {track.title}
 </h3>
