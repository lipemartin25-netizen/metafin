    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <div className="relative overflow-hidden flex flex-col items-center justify-center rounded-[2.5rem] bg-gradient-to-br from-gray-900 via-indigo-950 to-black p-10 md:p-14 text-white shadow-[0_20px_50px_-15px_rgba(0,0,0,0.5)] border border-white/10 text-center group perspective-1000">
                ...
                <h2 className="text-4xl md:text-5xl font-black mb-4 relative z-10 tracking-tight drop-shadow-lg scale-100 group-hover:scale-[1.02] transition-transform duration-500 text-transparent bg-clip-text bg-gradient-to-r from-gray-100 via-gray-300 to-gray-500">
                    Academy W1
                </h2>
                <p className="text-gray-300 text-base md:text-lg font-medium max-w-2xl relative z-10 leading-relaxed backdrop-blur-sm px-4">
                ...
                <div className="absolute inset-x-0 h-[2px] bg-gradient-to-r from-transparent via-brand-500 to-transparent top-0 opacity-0 group-hover:opacity-100 animate-[scan_3s_ease-in-out_infinite] shadow-[0_0_15px_rgba(16,185,129,0.8)]" />
            </div>
