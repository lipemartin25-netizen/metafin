...
export default function FreelaMEIHub() {
    ...
    return (
        <div className="space-y-8 animate-fade-in text-white/90 pb-20">
            <div className="glass-card p-6 border-l-4 border-l-cyan-500 relative overflow-hidden bg-black/40">
            ...
            <div className="grid md:grid-cols-2 gap-6">
                <div className="glass-card p-6 bg-black/20 border border-white/5 space-y-4">
                    ...
                    <input
                        ...
                        className="w-full bg-black/40 border border-white/10 rounded-xl px-4 py-3 text-white text-xl font-black outline-none focus:border-cyan-500 transition-colors"
                    />
                </div>
                <div className="glass-card p-6 bg-black/20 border border-white/5 space-y-4">
            ...
            <div className="grid md:grid-cols-3 gap-6">
                {/* DAS / Imposto */}
                <div className="glass-card flex flex-col gap-4 p-6 border border-gray-800">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xl font-black text-white">{fmt(das)}</p>
                        </div>
                    </div>
                    <div className="text-xs text-gray-400 bg-black/30 p-2 rounded-lg border border-white/5">
                        *Valor fixo MEI do INSS+ISS mensal. Separar dia 20.
                    </div>
                </div>

                {/* ProLabore Suggestion */}
                <div className="glass-card flex flex-col gap-4 p-6 border border-cyan-500/30 shadow-[0_0_20px_rgba(6,182,212,0.1)] relative overflow-hidden">
                    <div className="absolute top-0 right-0 bg-cyan-500 text-black text-[9px] font-black tracking-widest px-2 py-0.5 rounded-bl-lg uppercase">
                        Pró-Labore
                    </div>
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xl font-black text-white">{fmt(proLaboreIdea)}</p>
                        </div>
                    </div>
                    <div className="text-xs text-gray-400 bg-black/30 p-2 rounded-lg border border-white/5">
                ...
                {/* Caixa da Empresa */}
                <div className="glass-card flex flex-col gap-4 p-6 border border-accent/20">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xl font-black text-white">{fmt(businessReserve)}</p>
                        </div>
                    </div>
                    <div className="text-xs text-gray-400 bg-black/30 p-2 rounded-lg border border-white/5">
            ...
            <div className="text-center mt-10 p-6 glass-card bg-black/20 border-dashed border-2 border-white/10 uppercase font-black tracking-widest text-sm text-gray-500">
