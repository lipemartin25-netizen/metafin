...
export default function RetirementSimulator({ financialData }) {
    ...
    return (
        <div className="space-y-6 animate-fade-in">
            <div className="relative overflow-hidden rounded-[2.5rem] bg-gradient-to-br from-indigo-600 via-blue-600 to-cyan-700 p-8 md:p-12 text-white shadow-[0_20px_50px_-15px_rgba(79,70,229,0.4)] group border border-white/20 perspective-1000">
                {/* Efeitos 3D Internos */}
                ...
                <h2 className="text-2xl md:text-3xl font-black flex items-center gap-3 relative z-10 mb-8 tracking-tight">
                    <div className="p-2 bg-white/10 rounded-xl backdrop-blur-sm border border-white/20 shadow-inner group-hover:rotate-12 transition-transform duration-300">
                        <Calendar className="h-7 w-7 text-indigo-200 drop-shadow-md" />
                    </div>
                ...
                <div className="grid grid-cols-2 lg:grid-cols-5 gap-4 md:gap-6 relative z-10">
                    ...
                    <div className="lg:col-span-2 bg-black/20 backdrop-blur-md rounded-3xl p-5 border border-white/20 shadow-[0_10px_30px_rgba(0,0,0,0.2)] group-hover:-translate-y-1 transition-transform duration-300 delay-150">
                        ...
                        <p className={`text-lg md:text-xl font-black drop-shadow-[0_2px_10px_rgba(0,0,0,0.3)] mt-1 flex items-center gap-2 ${result.isSustainable ? 'text-emerald-300' : 'text-red-300'}`}>
                            {result.isSustainable ? (
                                <>
                                    <span className="h-3 w-3 rounded-full bg-emerald-400 animate-pulse shadow-[0_0_10px_rgba(52,211,153,0.8)]" />
                    ...
                    <div className="space-y-3">
                        <div className="grid grid-cols-2 gap-3">
                            <div>
                                ...
                                <input
                                    type="number"
                                    className="w-full bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-xl px-3 py-2 text-sm text-gray-900 dark:text-white outline-none focus:border-indigo-500"
                        ...
                        <div>
                            ...
                            <input
                                type="number"
                                className="w-full bg-gray-50 dark:bg-black/20 border border-gray-200 dark:border-white/10 rounded-xl px-3 py-2 text-sm text-gray-900 dark:text-white outline-none focus:border-green-500"
