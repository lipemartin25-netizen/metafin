...
function MobileNav({ navItems, handleSignOut }) {
 ...
 <div className="md:hidden fixed bottom-0 left-0 right-0 z-50 border-t border-[var(--border)] flex items-center overflow-x-auto hide-scrollbar safe-bottom"
 ...
 >
 <div className={`w-12 h-12 rounded-2xl flex items-center justify-center mb-2 transition-transform group-hover:-translate-y-px transition-transform ${location.pathname === item.to ? 'bg-brand-primary/20' : 'bg-gray-800/40/5 animate-pulse-slow'
 }`}>
