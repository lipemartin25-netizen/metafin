...
export default function TaxPlanner({ financialData }) {
 ...
 <div className="relative overflow-hidden flex flex-col items-center justify-center rounded-[2.5rem] bg-[var(--bg-base)] from-blue-600 via-indigo-600 to-brand-dark p-10 md:p-14 text-[var(--text-primary)] shadow-glass-card border border-[var(--border)] text-center group perspective-1000">
 {/* Efeitos 3D Internos */}
 ...
 <Shield className="w-16 h-16 text-blue-200 drop-shadow-glass-card animate-bounce-slow" />
 </div>
 ...
 <div className="absolute inset-x-0 h-1 bg-[var(--bg-base)] from-transparent via-blue-300 to-transparent bottom-0 opacity-0 group-hover:opacity-100 animate-[scan_2s_ease-in-out_infinite_reverse] shadow-glass-card" />
 </div>
 ...
 <input
 type="number"
 className="w-full bg-gray-800/30 dark:bg-black/20 border border-gray-700/40 dark:border-[var(--border)] rounded-xl px-3 py-2 text-sm text-[var(--text-primary)] dark:text-[var(--text-primary)] outline-none focus:border-blue-500"
 ...
 className="w-full bg-gray-800/30 dark:bg-black/20 border border-gray-700/40 dark:border-[var(--border)] rounded-xl px-3 py-2 text-sm text-[var(--text-primary)] dark:text-[var(--text-primary)] outline-none focus:border-blue-500 mt-1"
