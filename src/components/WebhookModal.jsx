...
export default function WebhookModal({ isOpen, onClose, onSuccess }) {
    ...
    return (
        ...
        >
            <div className="bg-[#0f172a] border border-white/10 rounded-2xl w-full max-w-lg max-h-[90vh] overflow-y-auto shadow-2xl animate-in zoom-in-95 duration-200">
                                ...
                                return (
                                    ...
                                    >
                                        ...
                                        <div className="flex-1 min-w-0 flex items-start gap-3">
                                            ...
                                            <div>
                                                <p className={`text-sm font-bold transition-colors ${selected ? 'text-white' : 'text-gray-300'}`}>{evt.label}</p>
