...
export const AI_MODELS = {
    ...
    'gpt-5': {
        ...
        icon: '🧠',
        color: '#10a37f',
        description: 'Análises financeiras profundas e complexas',
        costTier: '$$$',
        contextWindow: '400K',
        model: 'gpt-4o', // fallback para modelo disponível
    },
    'gemini-flash': {
        id: 'gemini-flash',
        name: 'Gemini Flash',
        ...
        icon: '✨',
        color: '#4285f4',
        description: 'Google AI — velocidade máxima com boa qualidade',
        costTier: '$',
        contextWindow: '1M',
        model: 'gemini-2.0-flash', // Atualizado para gemini-2.0-flash (mais recente) ou 1.5-flash
    },
    'claude-sonnet': {
        id: 'claude-sonnet',
        name: 'Claude Sonnet',
