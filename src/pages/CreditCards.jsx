...
export default function CreditCards() {
 ...
 <span className="font-bold text-content-primary dark:text-content-primary">{fmt(card.used)} <span className="text-gray-400 text-xs font-normal">/ {fmt(card.limit)}</span></span>
 </div>
