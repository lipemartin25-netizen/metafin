    ...
    return (
        <div className="py-8 space-y-8 animate-fade-in pb-24">
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4">
                <div>
                    <h1 className="text-3xl font-bold text-white dark:text-white flex items-center gap-2 mb-2">
            ...
            <div className="relative overflow-hidden rounded-2xl border border-white/5 shadow-2xl" style={{ background: 'linear-gradient(135deg, #0f172a 0%, #1e1b4b 50%, #0f172a 100%)' }}>
                ...
                <div className="relative z-10 px-6 pt-5 pb-0 flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-1.5 px-3 py-1 rounded-full bg-gray-800/40/5 border border-white/10">
                            ...
                            <div className="pt-3 mt-1 border-t border-white/5">
                                ...
                                <div className="flex gap-2 overflow-x-auto pb-1 scrollbar-hide">
                                    {analysis.topCategories.slice(0, 4).map((cat, i) => (
                                        <div key={i} className="flex-shrink-0 bg-gray-800/40/5 border border-white/5 px-2.5 py-1.5 rounded-lg flex items-center gap-2">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mt-4">
                ...
                <div className="space-y-4">
                    ...
                    <div className="${tw.card} space-y-6 p-6">
                                ...
                                <div key={cat.cat} className="space-y-3 group bg-gray-800/30/50 dark:bg-gray-800/40/[0.02] p-4 rounded-xl border border-transparent hover:border-purple-500/20 transition-all">
                                    <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 text-sm">
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-white dark:text-white capitalize font-bold">{cat.cat}</span>
                                            {hasGoal && isOverBudget && <AlertTriangle className="w-4 h-4 text-red-500 animate-pulse" />}
                                        </div>
                                        <div className="flex items-center gap-2 bg-gray-800/40 dark:bg-surface-800 p-1 rounded-lg border border-gray-700/40 dark:border-white/10 shadow-lg shadow-black/10">
                                            <span className={`font-bold px-2 ${isOverBudget ? 'text-red-500' : 'text-white dark:text-white'}`}>
                                                {fmt(cat.total)}
                                            </span>
                        ...
                        {analysis.topCategories.length === 0 && (
                            <div className="text-center py-10 border border-dashed border-gray-700/40 dark:border-white/10 rounded-2xl">
