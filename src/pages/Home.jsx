...
export default function Home() {
 ...
 <div className="pt-10 border-t border-[var(--border)] space-y-6 flex flex-col">
 <Link
 to="/login"
 onClick={() => setIsMenuOpen(false)}
 ...
 >
 <Link to="/signup" className="px-10 py-5 bg-gray-800/40 hover:bg-slate-100 text-slate-900 font-extrabold rounded-2xl transition-all flex items-center justify-center gap-2 shadow-elevated shadow-white/5 active:scale-95 group">
 Iniciar Agora
 ...
 {/* Footer */}
 <footer className="pt-32 pb-16 px-6 border-t border-[var(--border)] bg-[#0a0f1e] relative z-20">
