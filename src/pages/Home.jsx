        ...
        <div className="min-h-screen bg-[#0f172a] text-white overflow-x-hidden selection:bg-purple-500/30 font-sans antialiased">
            ...
            <header className={`fixed top-0 left-0 right-0 z-50 transition-all duration-500 ${scrolled ? 'bg-slate-900/90 backdrop-blur-xl border-b border-white/5 py-4 shadow-2xl' : 'bg-transparent py-8'}`}>
                <nav className="max-w-7xl mx-auto px-6 flex items-center justify-between">
                    ...
                    <button
                        ...
                        className="lg:hidden p-2 text-slate-300 hover:text-white transition-colors relative z-50 rounded-xl hover:bg-gray-800/40/5 active:bg-gray-800/40/10"
            ...
            <section className="relative pt-64 pb-48 px-6 z-10 text-center">
                <div className="max-w-7xl mx-auto">
                    ...
                    >
                        <Link to="/signup" className="px-10 py-5 bg-gray-800/40 hover:bg-slate-100 text-slate-900 font-extrabold rounded-2xl transition-all flex items-center justify-center gap-2 shadow-2xl shadow-white/5 active:scale-95 group">
                            Iniciar Agora
