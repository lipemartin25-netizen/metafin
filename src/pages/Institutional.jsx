...
const CONTENT = {
 ...
 <div>
 <strong className="text-[var(--text-primary)]">Criptografia em Repouso (AES-256)</strong>
 ...
 <CheckCircle2 className="w-5 h-5 text-brand-primary mt-1" />
 <div>
 <strong className="text-[var(--text-primary)]">TLS 1.3 em Trânsito</strong>
 ...
 body: (
 <div className="space-y-6 text-[var(--text-secondary)] prose prose-invert max-w-none">
 ...
 <h4 className="text-[var(--text-primary)]">1. Coleta de Dados</h4>
 ...
 <h4 className="text-[var(--text-primary)]">2. Uso de Dados</h4>
...
export default function Institutional() {
 ...
 body: <p className="text-[var(--text-secondary)]">Verifique o endereço e tente novamente.</p>
 };

 return (
 <div className="min-h-screen bg-[var(--bg-base)] text-[var(--text-primary)] font-sans selection:bg-brand-primary/30 overflow-x-hidden">
 {/* Background Subtle elements */}
 <div className="fixed inset-0 pointer-events-none z-0">
 <div className="absolute top-[-10%] right-[-5%] w-[40%] h-[40%] bg-brand-primary/[0.03] blur-[160px] rounded-full" />
 </div>

 <header className="fixed top-0 left-0 right-0 z-50 bg-[var(--bg-base)]/80 border-b border-[var(--border)] py-4">
 <div className="max-w-4xl mx-auto px-6 flex items-center justify-between">
 <Link to="/" className="flex items-center gap-2">
 <MetaFinLogo className="h-7 w-auto" />
 </Link>
 <Link to="/" className="text-[13px] font-bold text-[var(--text-secondary)] hover:text-[var(--text-primary)] flex items-center gap-2 transition-colors">
 ...
 <p className="text-xl text-[var(--text-secondary)] font-medium">{page.subtitle}</p>
 </motion.div>
 ...
 <p className="text-[10px] text-[var(--text-muted)] font-bold uppercase tracking-widest">Protocolo de Segurança Nexus Ativo</p>
 </div>
 </div>
 </main>
 </div>
