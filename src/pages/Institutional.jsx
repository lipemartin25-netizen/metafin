...
export default function Institutional() {
    ...
    return (
        <div className="min-h-screen bg-[#0f172a] text-white font-sans selection:bg-brand-primary/30 overflow-x-hidden">
            ...
            <main className="relative z-10 pt-48 pb-32 px-6">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="mt-16 pt-8 border-t border-white/5 flex flex-col items-center gap-6">
                        <Link to="/signup" className="px-10 py-4 bg-brand-primary hover:bg-brand-glow text-slate-950 font-black rounded-2xl transition-all shadow-xl shadow-brand-primary/10 active:scale-95">
