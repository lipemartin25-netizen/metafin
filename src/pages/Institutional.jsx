...
const CONTENT = {
 ...
 <div className="p-6 bg-surface-secondary rounded-2xl border border-[var(--border)]">
 <h4 className="text-content-primary font-bold mb-2">Nexus Core IA</h4>
 ...
 <div className="p-6 bg-surface-secondary rounded-2xl border border-[var(--border)]">
 <h4 className="text-content-primary font-bold mb-2">Open Finance Hub</h4>
 ...
 icon: <ShieldCheck className="w-12 h-12 text-brand-primary" />,
 body: (
 <div className="space-y-6 text-content-secondary">
 ...
 <CheckCircle2 className="w-5 h-5 text-brand-primary mt-1" />
 <div>
 <strong className="text-content-primary">Criptografia em Repouso (AES-256)</strong>
 ...
 <CheckCircle2 className="w-5 h-5 text-brand-primary mt-1" />
 <div>
 <strong className="text-content-primary">TLS 1.3 em Trânsito</strong>
 ...
 <div key={q} className="p-4 bg-surface-secondary rounded-xl border border-[var(--border)] hover:border-[var(--border)] cursor-pointer transition-all">
 <span className="text-sm font-medium text-content-primary">{q}</span>
 </div>
 ))}
 </div>
 </div>
 ...
 icon: <MessageSquare className="w-12 h-12 text-brand-primary" />,
 body: (
 <div className="space-y-6 text-content-secondary">
 ...
 <div className="flex justify-between items-center p-4 bg-surface-secondary rounded-xl border border-[var(--border)]">
 ...
 <span className="text-xs text-content-muted">Resposta em até 2h</span>
 </div>
 </div>
 </div>
 )
 ...
 <h4 className="text-content-primary font-bold mb-2">Cross-Platform</h4>
 ...
 <h4 className="text-content-primary font-bold mb-2">Painel de Analista</h4>
 ...
 icon: <Activity className="w-12 h-12 text-brand-primary" />,
 body: (
 <div className="space-y-6 text-content-secondary">
 <div className="p-6 bg-brand-primary/5 border border-brand-primary/20 rounded-2xl flex items-center gap-4">
 <div className="w-3 h-3 bg-brand-primary rounded-full animate-pulse" />
 <span className="text-brand-primary font-bold uppercase tracking-widest text-sm">Operacional: Todos os sistemas</span>
 </div>
 ...
 <div key={s.n} className="flex justify-between items-center p-4 bg-surface-secondary rounded-xl border border-[var(--border)]">
 <span className="text-sm">{s.n}</span>
 <span className="text-sm font-mono text-content-primary">{s.v}</span>
 </div>
 ))}
 </div>
 </div>
 ...
 icon: <Lock className="w-12 h-12 text-brand-primary" />,
 body: (
 <div className="space-y-6 text-content-secondary prose prose-invert max-w-none">
 ...
 <h4 className="text-content-primary">1. Coleta de Dados</h4>
 ...
 <h4 className="text-content-primary">2. Uso de Dados</h4>
 ...
 <div className="space-y-4">
 <div className="p-4 bg-surface-secondary rounded-xl border border-[var(--border)]">
 ...
 <div key={d} className="flex gap-3 items-center p-3 bg-surface-secondary rounded-xl border border-[var(--border)]">
 ...
 <div className="p-6 bg-surface-secondary rounded-2xl border border-[var(--border)] space-y-4">
 <div className="flex gap-3">
 <AlertCircle className="w-5 h-5 text-brand-primary" />
 <p className="text-sm font-bold text-content-primary">Transparência no Consentimento</p>
 </div>
...
export default function Institutional() {
 ...
 body: <p className="text-content-secondary">Verifique o endereço e tente novamente.</p>
 };

 return (
 <div className="min-h-screen bg-surface-primary text-content-primary font-sans selection:bg-brand-primary/30 overflow-x-hidden">
 {/* Background Subtle elements */}
 <div className="fixed inset-0 pointer-events-none z-0">
 <div className="absolute top-[-10%] right-[-5%] w-[40%] h-[40%] bg-brand-primary/[0.03] blur-[160px] rounded-full" />
 </div>

 <header className="fixed top-0 left-0 right-0 z-50 bg-surface-primary/80 border-b border-[var(--border)] py-4">
 <div className="max-w-4xl mx-auto px-6 flex items-center justify-between">
 <Link to="/" className="flex items-center gap-2">
 <MetaFinLogo className="h-7 w-auto" />
 </Link>
 <Link to="/" className="text-[13px] font-bold text-content-secondary hover:text-content-primary flex items-center gap-2 transition-colors">
 ...
 >
 <div className="mb-8 inline-block p-4 bg-surface-secondary rounded-3xl border border-[var(--border)] shadow-elevated">
 {page.icon}
 </div>
 <h1 className="text-4xl md:text-5xl font-extrabold tracking-tight mb-4">{page.title}</h1>
 <p className="text-xl text-content-secondary font-medium">{page.subtitle}</p>
 </motion.div>
 ...
 className="bg-surface-secondary border border-[var(--border)] p-8 md:p-12 rounded-[3rem] shadow-elevated"
 >
 {page.body}
 </motion.div>

 <div className="mt-16 pt-8 border-t border-[var(--border)] flex flex-col items-center gap-6">
 <Link to="/signup" className="px-10 py-4 bg-brand-primary hover:bg-brand-glow text-slate-950 font-black rounded-2xl transition-all shadow-elevated shadow-brand-primary/10 active:scale-95">
 Começar Agora Gratuitamente
 </Link>
 <p className="text-[10px] text-content-muted font-bold uppercase tracking-widest">Protocolo de Segurança Nexus Ativo</p>
 </div>
 </div>
 </main>
 </div>
