...
const CONTENT = {
            ...
            <div className="space-y-6 text-slate-300">
                ...
                <div className="space-y-4">
                    <div className="flex justify-between items-center p-4 bg-slate-900/50 rounded-xl border border-white/5">
                        ...
                        <span className="text-xs bg-emerald-500/10 text-emerald-500 px-2 py-1 rounded">Disponível</span>
                    </div>
                    <div className="flex justify-between items-center p-4 bg-slate-900/50 rounded-xl border border-white/5">
        ...
        body: (
            <div className="space-y-6 text-slate-300">
                <div className="p-6 bg-emerald-500/5 border border-emerald-500/20 rounded-2xl flex items-center gap-4">
                    ...
                    <span className="text-emerald-500 font-bold uppercase tracking-widest text-sm">Operacional: Todos os sistemas</span>
                </div>
    ...
    termos: {
        ...
        icon: <Scale className="w-12 h-12 text-emerald-500" />,
        body: (
            <div className="space-y-6 text-slate-300">
    ...
    return (
        <div className="min-h-screen bg-[#0f172a] text-white font-sans selection:bg-emerald-500/30 overflow-x-hidden">
            ...
            <div className="fixed inset-0 pointer-events-none z-0">
                <div className="absolute top-[-10%] right-[-5%] w-[40%] h-[40%] bg-emerald-500/[0.03] blur-[160px] rounded-full" />
            </div>
            ...
            <main className="relative z-10 pt-48 pb-32 px-6">
                <div className="max-w-3xl mx-auto">
                    ...
                    <div className="mt-16 pt-8 border-t border-white/5 flex flex-col items-center gap-6">
                        <Link to="/signup" className="px-10 py-4 bg-emerald-500 hover:bg-emerald-400 text-slate-950 font-black rounded-2xl transition-all shadow-xl shadow-emerald-500/10 active:scale-95">
