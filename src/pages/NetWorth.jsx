                        ...
                        <form onSubmit={handleSaveAsset} className="space-y-4">
                            <div>
                                ...
                                <input required type="text" placeholder="Ex: Apartamento Centro"
                                    className="w-full px-4 py-3 rounded-xl bg-gray-800/30 dark:bg-black/20 border border-gray-700/40 dark:border-white/10 focus:border-brand-primary focus:ring-1 focus:ring-emerald-500 outline-none transition-all text-sm text-white dark:text-white"
