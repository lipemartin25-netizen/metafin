...
export default function NetWorth() {
 ...
 <h2 className={`text-6xl font-extrabold tracking-tighter ${data.netWorth >= 0 ? 'text-content-primary dark:text-content-primary' : 'text-red-500'}`}>
 {fmt(data.netWorth)}
 </h2>
 ...
 <h3 className="text-lg font-semibold text-content-primary dark:text-content-primary mb-6">Evolução Histórica</h3>
 ...
 <h3 className="text-lg font-semibold text-content-primary dark:text-content-primary flex items-center gap-2">
 ...
 <p className={`text-xl font-bold mt-0.5 ${item.type === 'liability' ? 'text-red-500' : 'text-content-primary dark:text-content-primary'}`}>
 ...
 <p className="text-sm font-medium text-content-primary dark:text-content-primary mb-1">Nenhum Patrimônio Adicionado</p>
 ...
 <div>
 <p className="text-sm font-semibold text-content-primary dark:text-content-primary leading-tight">{a.name}</p>
 ...
 <button onClick={() => setShowModal(false)} className="absolute top-4 right-4 text-gray-500 hover:text-content-primary dark:hover:text-content-primary">
 <X className="w-5 h-5" />
 </button>

 <h2 className="text-xl font-bold text-content-primary dark:text-content-primary mb-6">Novo Registro</h2>
 ...
 className="w-full px-4 py-3 rounded-xl bg-gray-800/30 dark:bg-black/20 border border-gray-700/40 dark:border-[var(--border)] focus:border-brand-primary focus:ring-1 focus:ring-emerald-500 outline-none transition-all text-sm text-content-primary dark:text-content-primary"
 ...
 className={`px-3 py-3 rounded-xl text-sm font-bold border transition-all ${!form.is_liability ? 'bg-brand-primary/10 border-brand-primary/30 text-brand-primary dark:text-brand-glow shadow-card' : 'border-gray-700/40 dark:border-[var(--border)] text-gray-500 hover:bg-gray-800/30 dark:hover:bg-gray-800/40/5'}`}>
 + É um Ativo
 </button>
 <button type="button" onClick={() => setForm({ ...form, is_liability: true })}
 className={`px-3 py-3 rounded-xl text-sm font-bold border transition-all ${form.is_liability ? 'bg-red-500/10 border-red-500/30 text-red-600 dark:text-red-400 shadow-card' : 'border-gray-700/40 dark:border-[var(--border)] text-gray-500 hover:bg-gray-800/30 dark:hover:bg-gray-800/40/5'}`}>
 - Passivo (Dívida)
 </button>
 </div>
 </div>
