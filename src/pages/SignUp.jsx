...
export default function SignUp() {
    ...
    if (success) {
        return (
            <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-6 text-white font-sans selection:bg-brand-primary/30 antialiased">
    ...
    return (
        <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-6 relative overflow-hidden text-white font-sans selection:bg-brand-primary/30 antialiased">
                        ...
                        {step === 1 ? (
                            ...
                            >
                                <div className="space-y-3">
                                    ...
                                    <input
                                        ...
                                        required
                                        autoFocus
                                        className="w-full px-6 py-4 rounded-2xl bg-slate-800/40 border border-white/5 text-white placeholder-slate-600 focus:outline-none focus:border-brand-primary/50 focus:bg-slate-800/60 transition-all font-medium shadow-inner"
                                    />
                                </div>
                                <button type="submit" className="w-full py-4 bg-brand-primary hover:bg-brand-glow text-slate-950 font-black rounded-2xl transition-all active:scale-[0.98] shadow-2xl shadow-brand-primary/20 flex items-center justify-center gap-2 group">
                            ...
                            >
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                required
                                                className="w-full pl-6 pr-14 py-4 rounded-2xl bg-slate-800/40 border border-white/5 text-white placeholder-slate-600 focus:outline-none focus:border-brand-primary/50 focus:bg-slate-800/60 transition-all font-medium shadow-inner"
                                            />
                                            <button
                                                type="button"
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <button type="submit" disabled={loading} className="flex-1 py-4 bg-brand-primary hover:bg-brand-glow text-slate-950 font-black rounded-2xl transition-all active:scale-[0.98] shadow-2xl shadow-brand-primary/20 flex items-center justify-center">
