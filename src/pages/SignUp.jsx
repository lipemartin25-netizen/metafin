                        ...
                        >
                            {loading ? (
                                <>
                                    ...
                                    <span className="uppercase text-surface-950">Criando sua conta...</span>
                                </>
                            ) : (
                                <>
                                    <span className="uppercase">Começar Grátis</span>
                                    <ArrowRight className="w-5 h-5 group-hover:translate-x-1 transition-transform text-surface-950" />
                                </>
                            )}
                        </button>
                    </form>
