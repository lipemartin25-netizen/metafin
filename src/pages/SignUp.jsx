...
export default function SignUp() {
    ...
    if (success) {
        return (
            <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-6 text-white font-sans selection:bg-purple-500/30 antialiased">
                ...
                <div className="w-full max-w-md text-center animate-fade-in p-12 bg-slate-900/60 border border-white/5 rounded-[3rem] backdrop-blur-3xl shadow-2xl z-10">
                    <div className="w-20 h-20 bg-purple-500/10 rounded-full flex items-center justify-center mx-auto mb-10 shadow-inner">
        ...
        <div className="min-h-screen bg-[#0f172a] flex items-center justify-center p-6 relative overflow-hidden text-white font-sans selection:bg-purple-500/30 antialiased">
            ...
            <div className="w-full max-w-md z-10 animate-fade-in py-10">
                ...
                <div className="bg-slate-900/60 border border-white/5 p-10 rounded-[3rem] shadow-[0_30px_70px_-20px_rgba(0,0,0,0.6)] backdrop-blur-3xl relative overflow-hidden">
                    ...
                    <AnimatePresence mode="wait">
                        {step === 1 ? (
                            ...
                            >
                                ...
                                <button type="submit" className="w-full py-4 bg-purple-500 hover:bg-purple-400 text-slate-950 font-black rounded-2xl transition-all active:scale-[0.98] shadow-2xl shadow-purple-500/20 flex items-center justify-center gap-2 group">
                            ...
                            >
                                    ...
                                    <div className="space-y-3">
                                        ...
                                        <div className="relative">
                                            <input
                                                ...
                                                required
                                                className="w-full pl-6 pr-14 py-4 rounded-2xl bg-slate-800/40 border border-white/5 text-white placeholder-slate-600 focus:outline-none focus:border-purple-500/50 focus:bg-slate-800/60 transition-all font-medium shadow-inner"
                                            />
                                            <button
                                                type="button"
                                ...
                                <div className="flex gap-4">
                                    ...
                                    <button type="submit" disabled={loading} className="flex-1 py-4 bg-purple-500 hover:bg-purple-400 text-slate-950 font-black rounded-2xl transition-all active:scale-[0.98] shadow-2xl shadow-purple-500/20 flex items-center justify-center">
                    ...
                    <div className="mt-12 pt-8 border-t border-white/5 text-center relative z-10">
                        <div className="flex items-center justify-center gap-2 text-slate-500 text-[10px] font-black tracking-[0.2em] uppercase">
                            <Lock className="w-4 h-4 text-purple-500/80" />
                ...
                <p className="mt-10 text-center text-slate-500 text-xs font-bold leading-relaxed">
                    Já possui acesso estratégico? <Link to="/login" className="text-purple-500 hover:text-purple-400 transition-colors ml-1 uppercase tracking-wider">Entrar no Painel</Link>
                </p>
            </div>
        </div>
    );
