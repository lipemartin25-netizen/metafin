...
export default function Wealth() {
 ...
 <div>
 <h1 className="text-3xl font-black text-content-primary dark:text-content-primary flex items-center gap-2">
 ...
 ${activeTab === tab.id
 ? 'bg-indigo-600 text-content-primary shadow-lg shadow-black/10 shadow-indigo-500/20'
