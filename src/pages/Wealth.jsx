...
export default function Wealth() {
 ...
 <div>
 <h1 className="text-3xl font-black text-[var(--text-primary)] dark:text-[var(--text-primary)] flex items-center gap-2">
 ...
 ${activeTab === tab.id
 ? 'bg-indigo-600 text-[var(--text-primary)] shadow-lg shadow-black/10 shadow-indigo-500/20'
